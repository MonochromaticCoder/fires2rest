...
import type {
    FieldValue as Fires2RestFieldValue,
    Firestore as Fires2RestFirestore,
} from "../src/index.js";

export async function run(
    db: FirebaseAdminFirestore | Fires2RestFirestore,
    FieldValue: typeof FirebaseAdminFieldValue | typeof Fires2RestFieldValue,
) {
